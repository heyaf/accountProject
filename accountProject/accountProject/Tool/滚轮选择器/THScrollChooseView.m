...
- (instancetype)initWithQuestionArray:(NSArray *)questionArray withDefaultDesc:(NSString *)defaultDesc {
    ...
    if (self = [super init]) {
        ...
        [viewBg setBackgroundColor:KWhiteColor];
        ...
        [cannel setTitleColor:KSelectColor forState:UIControlStateNormal];
        cannel.tag = 1;
        ...
        [confirm setTitleColor:KSelectColor forState:UIControlStateNormal];
        confirm.tag = 2;
...
- (UIPickerView *)pickerView {
    ...
    if (!_pickerView) {
        _pickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(0, THfloat(45), THScreenW, THfloat(150))];
