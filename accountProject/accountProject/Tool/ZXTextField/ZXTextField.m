...
//        [inputText setValue:[UIColor grayColor] forKeyPath:@"_placeholderLabel.textColor"];
        NSMutableAttributedString *passwordPlaceholderString = [[NSMutableAttributedString alloc] initWithString:@" " attributes:@{NSForegroundColorAttributeName : KGrayColor}];
        inputText.attributedPlaceholder = passwordPlaceholderString;
